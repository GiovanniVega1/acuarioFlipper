...
export const About = () => {
  ...
  return (
    ...
    <p>
    Bienvenidos a Aquarium Flipper, un lugar mágico donde podrás explorar la belleza del mundo submarino. Desde hace más de una década, nos dedicamos a proporcionar una experiencia única a nuestros visitantes, acercándolos a la maravillosa vida marina que habita en nuestros acuarios. Descubre las maravillas ocultas de los océanos mientras te sumerges en nuestro entorno acuático espectacular.
</p>
<br /><br />
<p>
    Nuestro equipo de expertos biólogos marinos y cuidadores de animales se esfuerza por mantener un ambiente saludable y enriquecedor para nuestros habitantes marinos, que incluyen peces exóticos, tortugas, corales y muchas otras especies fascinantes. Trabajamos incansablemente en la conservación y protección de estas especies en peligro de extinción, participando en programas de reproducción y reintroducción de animales en su hábitat natural.
</p>
<br /><br />
<p>
    En Aquarium Flipper, también ofrecemos programas educativos para escuelas y familias. Nuestros talleres y visitas guiadas permiten a los visitantes aprender sobre la importancia de la biodiversidad marina y la necesidad de conservar nuestros océanos. Además, organizamos eventos especiales, como charlas de expertos y presentaciones interactivas, para inspirar el amor y el respeto por los océanos y sus habitantes. Esperamos que tu visita no solo sea educativa, sino también una experiencia inolvidable llena de descubrimientos y diversión.
</p>
<br /><br />
<p>
    ¿Sabías que nuestro acuario es hogar de algunas de las especies de peces más raras del mundo? Nuestra misión es mostrar a nuestros visitantes la diversidad de la vida marina y cómo podemos contribuir a su preservación. Con nuestras exhibiciones interactivas, te invitamos a conocer a nuestros animales de cerca y a comprender la importancia de conservar estos ecosistemas frágiles y asombrosos.
</p>
<br /><br />
<p>
    Como parte de nuestros esfuerzos de sostenibilidad, Aquarium Flipper ha adoptado prácticas amigables con el medio ambiente. Nuestros acuarios utilizan tecnología de vanguardia para garantizar el bienestar de nuestros habitantes marinos mientras minimizamos nuestro impacto en el entorno marino. Además, estamos comprometidos con la eliminación de plásticos de un solo uso en nuestras instalaciones y promovemos la reducción de residuos en general.
</p>
